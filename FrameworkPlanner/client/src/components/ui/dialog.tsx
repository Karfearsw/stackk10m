...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // CRM-UI-P0-001: no exit animation — Radix Presence would otherwise wait for
      // `animationend` (which never fires in hidden documents) and keep the modal's
      // body-level `pointer-events: none` alive, dead-clicking the whole app.
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Exit animations removed — CRM-UI-P0-001, see DialogOverlay above.
