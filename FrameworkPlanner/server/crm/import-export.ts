...
const opportunityFields: FieldDef[] = [
  ...
  { key: "propertyType", label: "Deal Type", type: "string" },
  { key: "unitCount", label: "Units (Doors)", type: "int" },
  { key: "noi", label: "NOI (Annual)", type: "decimal" },
  { key: "capRate", label: "Cap Rate %", type: "decimal" },
  { key: "zoning", label: "Zoning", type: "string" },
  { key: "parkingSpaces", label: "Parking Spaces", type: "int" },
  { key: "tenancy", label: "Tenancy", type: "string" },
  { key: "assignedTo", label: "Assigned To (User ID)", type: "int" },
...
const opportunitySynonyms: Record<string, string[]> = {
  ...
  propertyType: ["deal type", "property type", "property subtype", "subtype", "type"],
  unitCount: ["units", "unit count", "doors", "number of units"],
  noi: ["noi", "net operating income", "annual noi"],
  capRate: ["cap rate", "capitalization rate", "cap"],
  zoning: ["zoning", "zoning code"],
  parkingSpaces: ["parking", "parking spaces", "parking spots"],
  tenancy: ["tenancy", "tenancy type", "tenants"],
  assignedTo: ["assigned to", "assigned", "assignee", "assigned user", "assigned user id"],
