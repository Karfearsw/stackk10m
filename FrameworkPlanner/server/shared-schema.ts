...
export const notificationPreferences = pgTable("notification_preferences", {
  ...
  contractAlerts: boolean("contract_alerts").notNull().default(true),
  ...
  rvmUpdates: boolean("rvm_updates").notNull().default(true),
  ...
  frequency: varchar("frequency", { length: 50 }).notNull().default("instant"),
...
export const userNotifications = pgTable("user_notifications", {
  ...
  linkPath: varchar("link_path", { length: 500 }),
